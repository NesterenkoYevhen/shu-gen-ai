...
export const HeaderMobileMenuWrite:FC<IMobileMenuConroller> = ({ setActive }) => {
  const features = write.slice(0, 6);
  const others = write.slice(6);
        ...
        <div className="p-6 ">
          ...
          <ul className="flex flex-col gap-2 mt-4">
            ...
            <li className="bg-transparent hover:bg-neutralsGrey300-light dark:hover:bg-grey1-dark rounded-xl">
              <LocaleLink href="/search" onClick={() => setActive(false)}>
